...
if __name__ == "__main__":
    ...
    parser.add_argument("--root_dir", default="/data4/liruocheng/dataset/BTCV/abdomen/", type=str, help="root directory")
    ...
    parser.add_argument("--output_path", default="/data4/liruocheng/dataset/BTCV/abdomen/dataset.json")
