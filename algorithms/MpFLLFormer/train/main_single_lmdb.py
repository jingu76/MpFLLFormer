...
from dataset.datasets import get_loader, get_loader_lmdb
...
from algorithms.MpFLLFormer.train.trainer_single_lmdb import run_training
...
parser.add_argument("--logdir", default="/data4/MpFll_single/", type=str,
                    help="directory to save the tensorboard logs")
parser.add_argument(
    "--pretrained_dir", default="./pretrained_models/", type=str, help="pretrained checkpoint directory"
)
parser.add_argument("--data_dir", default="/data2/", type=str, help="dataset directory")
...
parser.add_argument("--dist-url", default="tcp://127.0.0.1:11456", type=str, help="distributed url")
...
parser.add_argument("--space_x", default=0.685, type=float, help="spacing in x direction")
parser.add_argument("--space_y", default=0.685, type=float, help="spacing in y direction")
...
parser.add_argument('--checkpoint_path', default='/data4/MpFll_single/')
...
parser.add_argument("--phase_id", default=[0], type=list, help="validation frequency")
...
def main_worker(gpu, args):
    ...
    model.to(args.gpu, non_blocking=True)
