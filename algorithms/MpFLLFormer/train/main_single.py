...
parser.add_argument("--logdir", default="/data4/liruocheng/checkpoint/BTCV/SwinUNETR_mamba/", type=str, help="directory to save the tensorboard logs")
parser.add_argument(
    "--pretrained_dir", default="./pretrained_models/", type=str, help="pretrained checkpoint directory"
)
parser.add_argument("--data_dir", default="/data4/liruocheng/dataset/BTCV/abdomen/", type=str, help="dataset directory")
...
parser.add_argument("--dist-url", default="tcp://127.0.0.1:4352", type=str, help="distributed url")
...
# parser.add_argument('--train_dir', default='/data1/tr6.0_lmdb_from_package')
# parser.add_argument('--val_dir', default='/data1/ts2.2_lmdb_from_package')
# parser.add_argument('--checkpoint_path', default='/data1/checkpoint_liruocheng/SwinUNETR_all_dataset/')
