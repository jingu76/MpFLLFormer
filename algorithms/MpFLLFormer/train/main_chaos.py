...
from trainer_chaos import run_training
from dataset.chaos_dataset import get_loader

from monai.inferers import sliding_window_inference
from monai.losses import DiceCELoss
from algorithms.MpFLLFormer.network.swin_unetr import SwinUNETR
...
def main_worker(gpu, args):
    ...
    semantic_classes = ["Dice_Liver", "Dice_Right_kidney", "Dice_Left_kidney", "Dice_Spleen"]
